<template>
  <div>
    <div class="bg-white position-absolute w-100 mt-5" style="z-index:2;">
    ...
    <div class="Section bg-light">
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 text-right py-2 px-2">
            <button class="btn btn-lg text-white Button mt-3 mb-4 rounded-pill">View More</button>
          </div>
        </div>
      </div>
    </div>

    <div class="Section Section--half bg-gradient-primary">
      <div class="container">
        <div class="row">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 text-center">
            ...
            <p class="lead">
              <a
                class="btn btn-light btn-lg text-white Button rounded-pill"
                target="_blank"
