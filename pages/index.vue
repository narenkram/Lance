  ...
  <div class="container">
    <div id="english" lang="en">
      <section
        id="intro"
        class="
          pt-3 pt-md-5 pt-lg-6 pt-xl-6
          mt-0 mt-sm-2 mt-md-3 mt-lg-4 mt-xl-4
        "
      >
    ...
    <div id="tamil" lang="tamil">
      ...
      >
        <div class="row justify-content-center">
          ...
          >
            ...
            <a href="#work-tamil" class="btn btn-secondary">என் வேலை</a>
            <a
              href="#contact-tamil"
              class="btn btn-primary ms-1 ms-md-2 ms-lg-2"
              >பேசலாம்</a
            >
          </div>
        </div>
      ...
      <section id="services-tamil" class="pt-4 pt-md-5 pt-lg-6 pt-xl-6">
